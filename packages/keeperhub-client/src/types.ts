...
export type ClientEvent =
  | { type: "request"; method: string; path: string; attempt: number; idempotencyKey?: string }
  | { type: "response"; method: string; path: string; status: number; ms: number; requestId?: string }
