...
export function deriveTransferKey(input: TransferKeyInput): string {
...
export function deriveContractCallKey(input: ContractCallKeyInput): string {
...
export function canonicalTransferBody(req: TransferRequest): CanonicalTransferBody {
...
export function canonicalContractCallBody(req: ContractCallRequest): CanonicalContractCallBody {
