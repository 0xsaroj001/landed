import type { ExecutionState, SimulationResult } from "./types.ts";
...
export class PreflightFailed extends KeeperHubError {
  ...
  constructor(message: string, simulation: SimulationResult, options: KeeperHubErrorOptions) {
...
export class IdempotencyConflict extends KeeperHubError {
  ...
  constructor(message: string, originalExecutionId: string | null, options: KeeperHubErrorOptions) {
...
export class RateLimited extends KeeperHubError {
  ...
  constructor(message: string, retryAfterSeconds: number, options: KeeperHubErrorOptions) {
    super(message, { ...options, retryable: true });
