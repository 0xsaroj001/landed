...
export class LandedError extends Error {
  ...
  constructor(code: LandedErrorCode, message: string, options: { reference?: string | undefined; details?: Record<string, unknown>; cause?: unknown } = {}) {
  ...
  toJSON(): Record<string, unknown> {
    return { error: this.code, message: this.message, reference: this.reference, ...this.details };
  }
}
